...
def Result():
    ...
    if (i==1):
        ...
        messagebox.showinfo('ProjectRajan', 'Please Choose one of Encryption or Decrption. Try again.')
...
wn.title("Encrypt and Decrypt your Messages with ProjectRajan")
